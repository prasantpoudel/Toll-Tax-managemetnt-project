...
?>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched"  pattern="[a-zA-Z]{1,32}+"  id="sname" name="sname" value="<?php  echo $row['StaffName'];?>" required='true'>
            </div>
            <div class="form-group">
              <label class="control-label">Contact Number</label>
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="smobno" name="smobno"value="<?php  echo $row['StaffMobilenumber'];?>" required='true' maxlength='10' minlength="10" pattern='[0-9]+'>
            </div>
            <div class="form-group">
