     ...
     <!-- Navigation -->
	   ...
	   <div class="xs">
        ...
        <form class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" method="post">
          <p style="font-size:16px; color:red" align-text="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" pattern="[a-zA-Z]{1,32}" required="true" id="oname" name="oname" value="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  pattern="[a-zA-Z]{1,32}" required="true" id="evcity" name="evcity" value="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" pattern="[0-9]+" required="true" id="cost" name="cost" value="">
            </div>
