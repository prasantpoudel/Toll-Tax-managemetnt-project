...
?>
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  pattern="[a-zA-Z]{1,32}" required="true" id="sname" name="sname" value="<?php  echo $row['StaffName'];?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" pattern="[0-9]+"  minlength="10" maxlength="10" id="smobnumb" name="smobnumb" value="<?php  echo $row['StaffMobilenumber'];?>" required="true" maxlength="10" pattern="[0-9]+">
            </div>
            <div class="form-group">
