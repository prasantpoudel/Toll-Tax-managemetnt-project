    ...
    echo $msg;
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"   pattern="[a-zA-Z]{1,32}" required="true" id="appname" name="appname" value="">
            </div>
            <div class="form-group">
              <label class="control-label">Age of Applicant</label>
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  maxlength="2" pattern="[0-9]+"   required="true" id="appage" name="appage" value="">
            </div>
            <div class="form-group">
              <label class="control-label">Applicant Gender: </label>
              <input type="radio" name="appgender" id="appgender" value="Female" checked="true">Male
              <label>
              <input type="radio" name="appgender" id="appgender" value="Male">Female
              </label>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" pattern="[0-9]+" required="true" id="costpass" name="costpass" value="">
            </div>
