    ...
    echo $msg;
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched"  pattern="[a-zA-Z]{1,32}" required="true" id="sname" name="sname" value="" >
            </div>
            <div class="form-group">
              <label class="control-label">Staff Mobile Number</label>
              <input type="text" class="form-control1 ng-invalid ng-valid-email ng-invalid-required ng-touched" id="smobnumb"  name="smobnumb" value="" required="true" minlength="10" maxlength="10" pattern="[0-9]+">
            </div>
            <div class="form-group">
