...
<div id="wrapper">
     <!-- Navigation -->
	   ...
	   <div class="xs">
        ...
        <form class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" method="post" name="bwdatesreport"  action="sales-reportspass-detail.php">
