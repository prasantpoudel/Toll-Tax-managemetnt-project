...
<h4 align-text="center" style="color:blue">Pass Sales Report  from <?php echo $m1."-".$y1;?> to <?php echo $m2."-".$y2;?></h4>
...
<tr>
                  <td colspan="2" align-item="center">Total </td>
...
$y2=date("Y",$year2);
 ...
 <h4 class="header-title m-t-0 m-b-30">Sales Report Year Wise</h4>
    <h4 align-item="center" style="color:blue">Sales Report  from <?php echo $y1;?> to <?php echo $y2;?></h4>
      <table class="table table-bordered">
        <thead>
          <tr>
            <th>S.NO</th>
